 ...
 */
public final class OAuth2ClientRegistration implements OAuth2ClientMetadataClaimAccessor, Serializable {

	@Serial
	private static final long serialVersionUID = 9162217014842046919L;
	...
	public static final class Builder {
		...
		public OAuth2ClientRegistration build() {
			validate();
			return new OAuth2ClientRegistration(this.claims);
		}
		...
		private void validate() {
			...
			Assert.notNull(this.claims.get(OAuth2ClientMetadataClaimNames.REDIRECT_URIS),
					"redirect_uris cannot be null");
